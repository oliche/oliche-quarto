...
![**Figure 6.** Signed slowness vs. spatial spread, every channel, coloured by Cosmos region.](figures/by_region_scatter.png)

The scatter itself is heavily overplotted at this density — the clearer read
is each region's median and IQR side by side:

![**Figure 7.** Per-Cosmos-region median + IQR, sorted by spatial spread.](figures/by_region_summary.png)
