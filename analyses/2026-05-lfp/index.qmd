...
![Matched channel locations for datasets 004 Shallow NP2 (left) and 005 Deep NP2 (right). NP1 channels (blue) and the depth-aligned NP2 channels (orange) are overlaid on a common y-axis.](figures/channel_locations.png){width=70%}
